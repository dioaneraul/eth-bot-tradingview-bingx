...
def webhook():
    ...
    try:
        # === Extragem parametrii din payload ===
        ...
        # === 0. Setăm leverage și margin mode ===
        try:
            client.change_margin_mode(symbol, "ISOLATED")  # sau "CROSSED"
